...
<div id="hd">
    ...
    <div id="tnb">
    	<div class="inner">
    		...
    		<ul id="hd_define">
    			<li class="active"><a href="<?php echo G5_URL ?>/index_old.php">커뮤니티</a></li>
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>/index_old.php"><img src="<?php echo G5_IMG_URL ?>/logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
